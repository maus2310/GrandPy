...
## How to get started
First have a look at the [getting started](./docs/notebooks/notebook_00_getting_started.ipynb) notebook.

Then, go through [differential expression](./docs/notebooks/notebook_01_differential_expression(snapshot_data).ipynb) or [kinetic modeling](./docs/notebooks/notebook_02_kinetic_modeling(progressive_labeling_time_courses).ipynb), which provide a comprehensive walk-through of the two main settings of nucleotide conversion experiments.
