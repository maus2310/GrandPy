...
## How to get started
First have a look at the [Getting started](notebooks/notebook_00_getting_started.ipynb) vignette.

Then, go through the [Differential expression](notebooks/notebook_01_differential_expression(snapshot_data).ipynb) or the [Kinetic modeling](notebooks/notebook_02_kinetic_modeling(progressive_labeling_time_courses).ipynb) vignette, which provide a comprehensive walk-through of the two main settings of nucleotide conversion experiments.
